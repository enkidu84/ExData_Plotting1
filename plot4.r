...
# subplot 2
plot(data1c$Voltage ,x=data1c$date_time, type = "l", ylab="Voltage", xlab = "datetime")
...
# subplot 4
plot(data1c$Global_reactive_powe ,x=data1c$date_time, type = "l", ylab="Global_reactive_powe", xlab = "datetime")
